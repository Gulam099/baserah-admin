...
import InformationFormDialog from "./GroupDialog";
                       ...
                       <div className="w-full">
                        {question.image ? (
                          <div className="relative w-full h-48 bg-gray-100 rounded-lg overflow-hidden">
                            {!imageErrors.has(question._id) ? (
                              <img
                                src={question.image}
                                alt={question.group_title}
                                className="w-full h-full object-cover transition-opacity duration-200"
                                onError={() => handleImageError(question._id)}
                                onLoad={() => handleImageLoad(question._id)}
                                loading="lazy"
                              />
                            ) : (
